...
export const FetchErrorPreview = ({ event }: Props) => (
  <>
    <Text>
      An error happened when trying to update the state. This might happen because one of the requested calls reverted.
    </Text>
